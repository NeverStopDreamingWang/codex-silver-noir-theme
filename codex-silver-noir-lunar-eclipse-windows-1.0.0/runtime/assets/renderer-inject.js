((cssText, artDataUrl, rawConfig) => {
  ...
  const normalizeConfig = (value) => {
    ...
    const appearance = ["auto", "light", "dark"].includes(config.appearance)
      ? config.appearance
      : "auto";
    const uiStyle = ["default", "black-gold-stage"].includes(config.uiStyle)
      ? config.uiStyle
      : "default";
  ...
  const applyProfile = (root) => {
    ...
    root.classList.toggle("dream-ui-black-gold-stage", config.uiStyle === "black-gold-stage");
